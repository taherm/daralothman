...
<!-- Mirrored from preview.oklerthemes.com/porto/6.0.0/index-header-below-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 18 Mar 2018 14:37:10 GMT -->
<head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('vendor/bootstrap/css/bootstrap-rtl.min.css')); ?>">
		...
		<link rel="stylesheet" href="<?php echo e(asset('vendor/circle-flip-slideshow/css/component.css')); ?>">
		
		<!-- Demo CSS -->


		<!-- Skin CSS -->
		<link rel="stylesheet" href="<?php echo e(asset('css/skins/default.css')); ?>">		<script src="<?php echo e(asset('master/style-switcher/style.switcher.localstorage.js')); ?>"></script> 
