...
<script src="<?php echo e(asset('vendor/jquery/jquery.min.js')); ?>"></script>
		...
		<script src="<?php echo e(asset('master/style-switcher/style.switcher.js')); ?>" id="styleSwitcherScript" data-base-path="" data-skin-src=""></script>
		...
		<script src="<?php echo e(asset('vendor/rs-plugin/js/jquery.themepunch.tools.min.js')); ?>"></script>		<script src="<?php echo e(asset('vendor/rs-plugin/js/jquery.themepunch.revolution.min.js')); ?>"></script>		<script src="<?php echo e(asset('vendor/circle-flip-slideshow/js/jquery.flipshow.min.js')); ?>"></script>		<script src="<?php echo e(asset('js/views/view.home.js')); ?>"></script>
    ...
    feed.run();
		...
		<script src="<?php echo e(asset('master/analytics/analytics.js')); ?>"></script>
